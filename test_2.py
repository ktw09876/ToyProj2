...
class ApprovalClient:
    def __init__(self):
        ###접속 정보 설정
        self.appkey, self.secretkey, self.base_url, self.end_url, self.hts_id = self.read_conf(r'C:\work_space\websocket\setting\setting.ini')
    ...
    def read_conf(self, ini_path: str) -> list:
        ...
        hts_id = config['setting']['hts_id']

        return appkey, secretkey, base_url, end_url, hts_id
...
async def connect():
    try:
        producer = KafkaProducer(
            bootstrap_servers=['localhost:9092'], # Docker Kafka 포트
    ...
    try:
        ...
        app = ApprovalClient()
        g_approval_key = app.get_approval(app.appkey, app.secretkey, app.base_url, app.end_url)
            ...
            while True:
                ...
                if data[0] == '0' or data[0] == '1':
                        try:
                            ...
                            producer.send(f'{trid_kafka}', key = message_key, value = data)
